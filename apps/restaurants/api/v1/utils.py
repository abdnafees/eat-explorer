...
from apps.restaurants.models import Restaurant, Location, Geometry, Photo
from eat_explorer.settings.local import (
    GOOGLE_MAPS_API_KEY,
)  # Import eat_explorer from decouple to read environment variables
