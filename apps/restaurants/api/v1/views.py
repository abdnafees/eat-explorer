...
from apps.restaurants.api.v1.paginations import CustomPagination
from apps.restaurants.api.v1.serializers import RestaurantSerializer
from apps.restaurants.api.v1.utils import create_restaurants
...
class RestaurantListAPIView(ListAPIView):
    ...
    # Add a filter apps to enable keyword and location filtering
